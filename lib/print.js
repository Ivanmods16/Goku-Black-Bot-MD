...
export default async function (m, conn = { user: {} }) {
  ...
  // Cambia todo a verde y el nombre del bot
  console.log(`${chalk.green('╭────═[ Luffy-Bot ]═─────⋆')}
${chalk.green('│╭───────────────···')}
${chalk.green('││')}👨‍💻 ${chalk.cyan('%s')} ⏱️ ${chalk.black(chalk.bgGreen('%s'))} 📂 ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.yellow('││')}🥷 ${chalk.greenBright('%s')} 🏦 ${chalk.yellow('%s%s')} ${chalk.blueBright('en')} 
${chalk.green('││')}💻 ${chalk.cyan('%s')} ${chalk.black(chalk.bgGreen('%s'))}
${chalk.green('│╰────────────────···')}
${chalk.green('╰───────────═┅═──────────')}`.trim(), 
