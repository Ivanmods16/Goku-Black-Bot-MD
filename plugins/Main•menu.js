...
│🍂⃟📆┊Fecha » \`\`\`${moment.tz('America/Asuncion').format('DD/MM/YY')}\`\`\`
│🍂⃟🕑┊Activa » \`\`\`${uptime}\`\`\`
...
await conn.sendMessage(m.chat, { image: { url: img.getRandom() }, caption: menu, contextInfo: { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, newsletterName: channelRD.name, serverMessageId: -1, }, forwardingScore: 999, externalAdReply: { title: 'Yagami-Bot-MD ✨', body: dev, thumbnailUrl: perfil, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false,
